...
# Custom CSS for the UI, now including the animated box
st.markdown("""
<style>
    ...
    .animated-box {
        ...
        box-shadow: 6px 6px 20px rgba(0,0,0,0.4);
        margin-bottom: 25px;
        animation: color-change 5s infinite; /* The animation property */
    }
    
    @keyframes color-change {
        0% { border: 2px solid #ff0000; }  /* Red */
        25% { border: 2px solid #ffff00; } /* Yellow */
        50% { border: 2px solid #00ff00; } /* Green */
        75% { border: 2px solid #0000ff; } /* Blue */
        100% { border: 2px solid #ff0000; } /* Back to red */
    }
</style>
